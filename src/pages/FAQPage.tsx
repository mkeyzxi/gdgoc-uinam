...
const FAQPage = () => {
  ...
  return (
    <section
      id="faq"
      className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-green-50 to-green-100 pl-6 md:px-6 overflow-hidden"
    >
            ...
            <div className="relative flex justify-center items-center">
              ...
              {!ready && (
                <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm z-20">
                  <IndicatorLoadingStack />
                </div>
              )}

              {/* Stack tetap dirender tapi disembunyikan sebelum siap */}
              <div
              ...
              >
                <Stack
                  ...
                  cardDimensions={{ width: 250, height: 360 }}
                  cardsData={images}
                  onReady={() => setReady(true)} // callback ketika Stack sudah siap
                />
              </div>
            </div>
