...
// 	return (
// 		<section className="w-full bg-blue-400 text-white flex flex-col justify-center items-center text-center gap-3 p-10">
// 			<TypographyH4>{judul}</TypographyH4>
// 			{subJudul && <TypographyAbout>{subJudul}</TypographyAbout>}
